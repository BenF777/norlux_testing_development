...
print(readSeqsumm(tumour.data=read.table(sample.file)))
...
#references <- data.frame(type="NPHD2015A", id= "69001-DNA-BLUT", lib="Agilent_L0016")
...
#rco <- readSeqsumm(tumour.data=read.table(out.file, header=TRUE))
#
#
#
